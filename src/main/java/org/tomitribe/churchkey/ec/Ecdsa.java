...
public class Ecdsa {
    ...
    public enum Curve {
        ...
        frp256v1(spec(
                ...
                "F1FD178C0B3AD58F10126DE8CE42435B53DC67E140D2BF941FFDD459C6D655E1", 1)),
        nistK163(spec(
        ...
        private static ECParameterSpec spec(final String fp, final String a, final String b, final String x, final String y, final String n, final int h) {
        ...
        Curve(final ECParameterSpec parameterSpec) {
            this.parameterSpec = parameterSpec;
        }

        public static Curve resolve(final String curveName) {
            final String enumName = curveName.toLowerCase(Locale.ENGLISH).replaceAll("[ /_.-]+", "");
