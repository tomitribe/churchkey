...
public class KeyDecodeSetTest {
    ...
    public void rsaPublicPemX509() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPublicPemX509.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void rsaPublicOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPublicOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void rsaPublicSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPublicSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void rsaPublicJwk() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPublicJwk.jwk"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void rsaPrivatePemPkcs8() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPrivatePemPkcs8.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void rsaPrivateOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPrivateOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void rsaPrivateSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("rsaPrivateSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void dsaPublicPemPkcs1() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPublicPemPkcs1.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void dsaPublicPemX509() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPublicPemX509.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void dsaPublicOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPublicOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void dsaPublicSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPublicSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void dsaPublicJwk() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPublicJwk.jwk"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void dsaPrivatePemPkcs8() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPrivatePemPkcs8.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void dsaPrivateOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPrivateOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void dsaPrivateSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("dsaPrivateSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void ecPublicPemPkcs1() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPublicPemPkcs1.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void ecPublicPemX509() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPublicPemX509.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void ecPublicOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPublicOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void ecPublicSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPublicSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void ecPublicJwk() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPublicJwk.jwk"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PUBLIC, key.getType());
    ...
    public void ecPrivatePemPkcs8() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPrivatePemPkcs8.pem"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void ecPrivateOpenSsh() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPrivateOpenSsh.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void ecPrivateSsh2() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPrivateSsh2.txt"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
    ...
    public void ecPrivateJwk() throws Exception {
        final List<Key> keys = Keys.decodeSet(resource.bytes("ecPrivateJwk.jwk"));
        assertEquals(1, keys.size());
        final Key key = keys.get(0);
        assertNotNull(key);
        assertEquals(Key.Type.PRIVATE, key.getType());
