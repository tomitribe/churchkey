...
public class JwkSecretKeyEncodeTest extends org.junit.Assert {
    ...
    public void testHs256SecretKey() throws Exception {
        ...
        assertEquals("{" +
                ...
                "\"use\":\"sig\"," +
                "\"kid\":\"orange-1234\"," +
                "\"k\":\"VZ-0QGLZ2P_RPUSW10CIu0WMyXq-ND2pmD" +
                "YzA0OTKWTHlp5iac5K4VeiRr-_BOoXJ4X2fSTt4nHwo" +
                "_quta7jJJKT4PEWyYanBSFsi0DW7owT-HExAGDyJtHU" +
                "tNw5xss8Nj6OxNPv6rROE-kevhL2wB9cqgdIscbvDhr" +
                "as39cwfs\"," +
                "\"kty\":\"oct\"" +
                "}", new String(encode));
    }
